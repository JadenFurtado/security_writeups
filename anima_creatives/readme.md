...
Though the API endpoints are now being sanitized, and an SQL injection is no longer possible, the site as a whole is still insecure. There are still vulnerabilities that have not been fixed till date. I have been begging them to fix the issues for well over 2 years now (it goes way back to 2019) and I am done trying to protect them! I guess some agencies never learn until it's too late. If they get hacked, too bad, but then, that is not my problem...
